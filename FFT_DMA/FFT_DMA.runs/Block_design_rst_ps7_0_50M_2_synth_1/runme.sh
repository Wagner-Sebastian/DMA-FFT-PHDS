...
HD_PWD='D:/Vivado Projects/FFT_DMA/FFT_DMA.runs/Block_design_rst_ps7_0_50M_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_design_rst_ps7_0_50M_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_design_rst_ps7_0_50M_2.tcl
