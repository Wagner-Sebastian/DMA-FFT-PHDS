...
HD_PWD='D:/Vivado_Projects/FFT_DMA/FFT_DMA.runs/Block_design_axi_dma_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_design_axi_dma_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_design_axi_dma_0_1.tcl
